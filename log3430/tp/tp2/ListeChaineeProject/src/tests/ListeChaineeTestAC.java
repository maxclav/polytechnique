...
public class ListeChaineeTestAC {
	...
	public void test1() throws IOException {	
		...
		try {
			myListActual_ = listeChainee_.build(union_, val1_1, val2_1, 1, 1, 1);
		}
	...
	public void test2() throws IOException {	
		...
		try {
			myListActual_ = listeChainee_.build(intersection_, val1_1, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			fail("Erreur test 2. ");
		}
	...
	public void test3() throws IOException {	
		...
		try {
			myListActual_ = listeChainee_.build(difference_, val1_1, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			fail("Erreur test 3. ");
		}
	...
	public void test4() throws IOException {	
		...
		try {
			myListActual_ = listeChainee_.build(symmetricDifference_, val1_1, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			fail("Erreur test 4. ");
		}
	...
	public void test5() throws IOException {	
		...
		try {
			myListActual_ = listeChainee_.build(isSubset_, val1_1, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			fail("Erreur test 5. ");
		}
	...
	public void test6() throws IOException {	
		...
		try {
			myListActual_ = listeChainee_.build(isSuperset_, val1_1, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			fail("Erreur test 6. ");
		}
	...
	public void test7() throws IOException {	
		...
		try {
			...
			myListActual_ = listeChainee_.build(invalidOp_, val1_1, val2_1, 1, 1, 1);
		}
	...
	public void test8() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(union_, val1_1, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 8. ");
	...
	public void test9() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(intersection_, val1_1, val2_2, 1, 1, 1);
		} catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 9. ");
		}
	...
	public void test10() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(difference_, val1_1, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 10. ");
	...
	public void test11() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(symmetricDifference_, val1_1, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 11. ");
	...
	public void test12() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(isSubset_, val1_1, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 12. ");
	...
	public void test13() throws IOException {		
		...
		try {
			...
			myListActual_ = listeChainee_.build(isSuperset_, val1_1, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 13. ");
	...
	public void test14() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(invalidOp_, val1_1, val2_2, 1, 1, 1);
		} 
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 14. ");
	...
	public void test15() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(union_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 15. ");
	...
	public void test16() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(intersection_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 16. ");
	...
	public void test17() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(difference_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 17. ");
	...
	public void test18() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(symmetricDifference_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 18. ");
	...
	public void test19() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(isSubset_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 19. ");
	...
	public void test20() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(isSuperset_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 20. ");
	...
	public void test21() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(invalidOp_, val1_2, val2_1, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 21. ");
	...
	public void test22() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(union_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 22. ");
	...
	public void test23() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(intersection_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 23. ");
	...
	public void test24() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(difference_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 24. ");
	...
	public void test25() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(symmetricDifference_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 25. ");
	...
	public void test26() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(isSubset_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 26. ");
	...
	public void test27() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(isSuperset_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 27. ");
	...
	public void test28() throws IOException {
		...
		try {
			...
			myListActual_ = listeChainee_.build(invalidOp_, val1_2, val2_2, 1, 1, 1);
		}
		catch (final Throwable t)  {
			System.out.println("[Erreur détecté]" + "\n");
			fail("Erreur test 28. ");
